...
import { VerifiedCheckIcon } from '../../../components/icons/verified-check-svgrepo';
import { ClosetTableVerified } from '../../../components/closet-table-verified';
...
export default function VerifiedClosetPage({ clientServer, cookie, outfits, userRatings, closetName, username, error }: Props) {
    if (error) {
        return (
            <>
        ...
        <>
            ...
            <main className="mt-6 p-3 md:p-8">
                <section className="my-4">
                    ...
                    <h2 className="capitalize">{closetName}&apos;s Closet - 2023</h2>
                    <VerifiedCheckIcon />
                    </div>
                    <div>Select items from the closet below to see outfits that contain them.</div>
                    <ClosetTableVerified outfits={outfits} cookie={cookie} clientServer={clientServer} userRatings={userRatings}/>
                </section>
            </main >
            <Footer />
        </>
