...
export const getServerSideProps: GetServerSideProps = async (context) => {
  let props: Props = {
    ...
    metadata: {
      ...
      description:
        "Collect user generated content for your business on RateYourStyle.",
    },
  };
    ...
    <>
      ...
      <main className="mt-12 sm:mt-20 px-4 md:px-8 w-full md:w-3/4">
        <section className="mb-4">
          ...
          <h5 className="my-2">
            Who, or what business do you want to see on RateYourStyle?
          </h5>{" "}
          <div>
            Whether it&apos;s an apparel brand, a celebrity, a local boutiqe, an
            influencer, a clothing designer, a fashion blogger, or anything in
            between, we will try to partner with them and curate their closet
            based on public outfits they&apos;ve posted.
          </div>
          <form className="grid grid-cols-4 w-full gap-x-2 gap-y-4 p-4 border-2 rounded mt-4">
            {submissionStatus == "success" ? (
              <div className="col-span-4">
                Thanks for submitting a closet request! Please allow for 1-2
                business days for us to fulfill it, and we&apos;ll let you know
                as soon as the closet is up.{" "}
              </div>
            ) : (
              submissionStatus && (
                <div className="col-span-4">
            ...
            {!submissionStatus && (
              <>
                ...
                <div className="col-span-4 flex gap-2 items-center">
                  ...
                  />
                  <label>
                    This is my own brand, store and/or business, and I&apos;d
                    like RateYourStyle to start curating my closet for me.
                  </label>
                </div>
                {validationErr && (
                  <div className="col-span-4 w-fit p-2 bg-red-700 text-white">
                    {validationErr}
                  </div>
                )}

                <button
                  className="bg-gradient w-full col-span-4 rounded p-2"
