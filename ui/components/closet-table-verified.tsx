...
export function ClosetTableVerified(props: { outfits: Outfit[], cookie: string, clientServer: string, userRatings: Rating[] | null, onlyTable?: boolean, includeEdit?: boolean }) {
